...
const CarouselSection: React.FC = () => {
  ...
  <Card className="w-[98%] mx-auto rounded-xl shadow-sm border border-[hsl(var(--border))] bg-white h-full flex flex-col">
          <CardHeader className="pb-2 py-4">
            <CardTitle className="text-sm font-medium flex items-center gap-2"><span className="text-yellow-500 text-base leading-none">🎉</span><span>Birthdays</span></CardTitle>
          </CardHeader>
