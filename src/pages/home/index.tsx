...
import { CalendarClock, Leaf, IdCard, Users, FileText, BarChart2 } from 'lucide-react'
						...
						<CardContent className="p-6 lg:p-7">
							<div className="flex flex-col lg:flex-row gap-8 lg:items-start">
								<div className="flex-1 min-w-0 space-y-6">
									...
									{/* Quote inside main greeting card */}
									<div className="relative overflow-hidden rounded-md border border-[hsl(var(--border))]/60 bg-gradient-to-r from-[hsl(var(--primary))]/8 via-white to-[hsl(var(--secondary))]/5 px-5 py-4">
										<div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-[hsl(var(--primary))] to-[hsl(var(--secondary))]" />
										<div className="pl-3 flex items-start gap-3">
											<span className="text-3xl leading-none select-none opacity-30 -mt-1">“</span>
											<div className="flex-1">
												<h3 className="text-[11px] font-semibold tracking-wide uppercase text-foreground/60 mb-1">Quote of the Day</h3>
												<p className="text-sm md:text-[15px] font-medium text-foreground/90 leading-relaxed italic">{quote}</p>
											</div>
											<span className="text-3xl leading-none select-none opacity-20 self-end hidden sm:inline">”</span>
										</div>
									</div>
								</div>
